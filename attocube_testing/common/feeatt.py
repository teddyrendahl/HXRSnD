...
class Feeatt(object):
  ...
  def __init__(self,lclsinstance):
    ...
    # for some reason the last 3 attenuators have inverted CMD logic
#    self.att[6] = Filter("SATT:FEE1:327",glass,76e-6,invert=True); changed to 500um diamond on Aug. 24th 2011
    ...
    self.att[7] = Filter("SATT:FEE1:328",al2o3,127e-6,invert=True)
    self.att[8] = Filter("SATT:FEE1:329",al2o3,250e-6,invert=True)
    self.setE()
